Config = {
    ...
    Locations = {
        [1] = {
            ["shelfs"] = {
                ...
                {["x"] = 33.50, ["y"] = -1345.03, ["z"] = 29.5, ["value"] = "alcohol"},
        ...
        [21] = {
            ["shelfs"] = {
                {["x"] = 189.76, ["y"] = -890.53, ["z"] = 30.71, ["value"] = "checkout"},
                {["x"] = 190.1, ["y"] = -900.63, ["z"] = 30.71, ["value"] = "drinks"},
                {["x"] = 192.44, ["y"] = -901.3, ["z"] = 30.71, ["value"] = "alcohol"},
                {["x"] = 193.26, ["y"] = -897.94, ["z"] = 30.71, ["value"] = "snacks"},
                {["x"] = 186.76, ["y"] = -894.5, ["z"] = 30.71, ["value"] = "readymeal"},
                {["x"] = 190.79, ["y"] = -888.3, ["z"] = 30.71, ["value"] = "diverse"},
            },
            ["blip"] = {
                ["x"] = 185.72, ["y"] = -890.24, ["z"] = 30.71
            },
            ["cashier"] = {
                ["x"] = 188.4, ["y"] = -890.13, ["z"] = 29.71, ["h"] = 255.78
            },
        },
    },
    ...
    Items = {
        ["drinks"] = {
            {label = "Coca Cola", item = "cocacola", price = 14},
            {label = "Fanta Exotic", item = "fanta", price = 14},
            {label = "Sprite", item = "sprite", price = 14},
            {label = "Redbull", item = "redbull", price = 14},
            {label = "Coffee", item = "coffee", price = 10},
        },
        ["alcohol"] = {
            {label = "Beer", item = "beer", price = 14},
            {label = "Plzen", item = "plzen", price = 14},
            {label = "Wine", item = "wine", price = 35},
            {label = "Vodka", item = "vodka", price = 45},
            {label = "Tatra", item = "tatra", price = 50},
            {label = "Rhum", item = "rhum", price = 80},
            {label = "Limonade", item = "limonade", price = 70},
            {label = "Grand_cru", item = "grand_cru", price = 85},
            {label = "Golem", item = "golem", price = 90},
            {label = "Champagne", item = "champagne", price = 100},
        },
        ["snacks"] = {
            {label = "Bolchips", item = "bolchips", price = 12},
            {label = "Bolpistache", item = "bolpistache", price = 12},
            {label = "Bolcacahuetes", item = "bolcacahuetes", price = 12},
            {label = "Bolnoixcajou", item = "bolnoixcajou", price = 12},
        },
        ["readymeal"] = {
            {label = "Pizza salam", item = "pizza_salam", price = 30},
            {label = "Pizza mozzarella", item = "pizza_mozzarella", price = 35},
            {label = "Lasagne", item = "lasagne", price = 18},
            {label = "Salat", item = "salat", price = 8},
        },
        ["diverse"] = {
            {label = "Cigarette", item = "cigarette", price = 10},
            {label = "Rarecigar", item = "rarecigar", price = 20},
            {label = "Trisslott", item = "lotteryticket", price = 20},
            {label = "White phone", item = "white_phone", price = 1200},
            {label = "Green phone", item = "green_phone", price = 1200},
            {label = "Blue phone", item = "blue_phone", price = 1200},
        },
    },
}